...
public partial class LocalizationManager
{
    private static readonly IReadOnlyDictionary<string, string> ChineseSimplifiedLocalization =
        new Dictionary<string, string>
        {
            ...
            [nameof(DownloadThumbnailLabel)] = "下载封面",
            [nameof(DownloadThumbnailTooltip)] = "将视频封面作为单独图片文件下载",
            [nameof(DownloadClosedCaptionsLabel)] = "下载字幕",
            [nameof(DownloadClosedCaptionsTooltip)] = "将字幕作为单独的 SRT 文件下载（如果可用）",
            [nameof(TranslateClosedCaptionsLabel)] = "将字幕翻译为中文",
            [nameof(TranslateClosedCaptionsTooltip)] = "尽可能将已下载字幕翻译成中文 SRT 文件",
            [nameof(TranslateKeyLabel)] = "Azure 翻译密钥",
            [nameof(TranslateKeyTooltip)] = "Microsoft Azure 翻译服务的密钥",
            [nameof(BaiduAppIdLabel)] = "百度 AppId",
            [nameof(BaiduAppIdTooltip)] = "百度翻译 API 的 AppId",
